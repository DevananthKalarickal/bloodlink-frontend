...
import { FaUserTie, FaPhone, FaEnvelope, FaGlobe, FaMapMarkerAlt, FaHospital } from "react-icons/fa";
          ...
          <Row>
            <Col xs={12}>
              <div className="d-flex gap-2 align-items-center mb-3" data-aos="fade-left">
                ...
                <span className="text-secondary">{donorInfo.hospitalName || "N/A"}</span>
              </div>
              <div className="d-flex gap-2 align-items-center mb-3" data-aos="fade-left">
