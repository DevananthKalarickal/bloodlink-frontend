          ...
          <div className="container space-y-8">
            <div className="header d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center gap-2">
                ...
                <h1 className="text-center" style={{ fontSize: '2rem', fontWeight: '600', color: '#333', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.1)' }}>
            ...
            <div className="performance-graph">
              <Card className="shadow-lg">
                <Card.Header>
                  <h5 className="m-0">Blood Donation & Request Performance</h5>
                </Card.Header>
                <Card.Body>
            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4">
              {data.map((record, i) => (
                <div key={i} className="col" data-aos="zoom-in" data-aos-delay={i * 150}>
                  <Card className="blood-card overflow-hidden shadow-lg rounded">
                    <Card.Header className="blood-header" style={getBloodGroupColor(record.bloodGroup)}>
                    ...
                    <tbody>
                      {inventoryData.map((record) => (
                        <tr key={record._id} data-aos="fade-left" data-aos-delay="300">
                          <td>
                            <span className="badge text-white" style={getBloodGroupColor(record.bloodGroup)}>
                              {record.bloodGroup}
                            </span>
                          </td>
                          <td>
                            <span className={record.inventoryType === "in" ? "text-success" : "text-danger"}>
